...
;; feed
(def Feed (component S/Feed))
(def FeedEvent (component S/Feed "Event"))
(def FeedLabel (component S/Feed "Label"))
(def FeedContent (component S/Feed "Content"))
(def FeedSummary (component S/Feed "Summary"))
(def FeedUser (component S/Feed "User"))
(def FeedDate (component S/Feed "Date"))
(def FeedMeta (component S/Feed "Meta"))
(def FeedExtra (component S/Feed "Extra"))
